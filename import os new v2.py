...
# ENV - PostgreSQL
# =========================
PG_HOST = os.getenv("PG_HOST", "76.13.18.225")
PG_PORT = os.getenv("PG_PORT", "5432")
PG_DB = os.getenv("PG_DB")
PG_USER = os.getenv("PG_USER")
PG_PASSWORD = os.getenv("PG_PASSWORD")
PG_SCHEMA = os.getenv("PG_SCHEMA", "dashboard")
PG_TABLE = os.getenv("PG_TABLE", "lte_cell_daily")

# =========================
# File filter
# - terima LTE_CELL_DAILY_*.csv dan LTE_CELL_DAILY *.csv
# =========================
PATTERN = re.compile(r"^LTE_CELL_DAILY[\s_].*\.csv$", re.IGNORECASE)
...
def main():
    ...
    print("== Start ingest LTE_CELL_DAILY* (Graph) -> PostgreSQL ==")
    ...
    print(f"✅ Ketemu {len(files)} file LTE_CELL_DAILY*.csv (ignored non-match: {ignored})")
