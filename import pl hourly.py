...
PG_TABLE = os.getenv("PG_TABLE", "packet_loss_hourly")

# =========================
# File filter
# - terima 2G_daily_*.csv dan 2G_daily *.csv
# =========================
PATTERN = re.compile(r"^PL Hourly[\s_].*\.csv$", re.IGNORECASE)
...
def main():
    ...
    print(f"✅ Ketemu {len(files)} file PL Hourly*.csv (ignored non-match: {ignored})")
