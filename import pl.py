...
PG_TABLE = os.getenv("PG_TABLE", "packet_loss")

# =========================
# File filter
# - terima 2G_daily_*.csv dan 2G_daily *.csv
# =========================
PATTERN = re.compile(r"^TWAMP  SCPT PL[\s_].*\.csv$", re.IGNORECASE)
...
def main():
    ...
    print(f"✅ Ketemu {len(files)} file TWAMP  SCPT PL*.csv (ignored non-match: {ignored})")
